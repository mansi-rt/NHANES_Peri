...
/******************** 
   ...
   *****************/
	...
	/*
	<LinHY, commnet: only with 28 teeth data, so it is not correct to use 32- missing teeth for remining teeth
    ...
    do i = 1 to dim(teeth_status);
        if teeth_status[i] in (1, 3, 4, 5) then missing_teeth_count + 1;
    end;
 ...
 *var peri_t02 peri_t03 peri_t04 peri_t05 
    ...
    peri_t20 peri_t21 peri_t22 peri_t23 
    peri_t24 peri_t25 peri_t26 peri_t27 
    peri_t28 peri_t29 peri_t30 peri_t31 miss_teeth_ct peri_g2 peri_test;
...
var t02 t03 t04 t05 
    ...
    t20 t21 t22 t23 
    t24 t25 t26 t27 
    t28 t29 t30 t31 miss_teeth_ct peri_g2 peri_test;
run;
